...
async def convert_coordinates(
    ...
    try:
        ...
        result_df = GSK_2011(sk1=source_system, sk2=target_system, parameters_path=parameters_path, df=df)
        ...
        filename = f"converted_{timestamp}.csv"
        ...
        logger.error(f"Error in convert_coordinates: {str(e)}", exc_info=True)
